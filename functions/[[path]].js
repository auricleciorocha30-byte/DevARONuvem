export async function onRequest(context) {
  ...
  if (url.pathname === "/api-health") {
    return new Response(JSON.stringify({ status: "ok", platform: "Cloudflare Pages Functions" }), {
      headers: { ...corsHeaders, "Content-Type": "application/json" }
    });
  }

  // PAGBANK CHECKOUT - Generic name to bypass WAF
  ...
  // FALLBACK TO STATIC ASSETS OR NEXT
